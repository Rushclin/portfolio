...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/rushclin-takam/",
        icon: Icons.linkedin,
      ...
      email: {
        name: "Send Email",
        url: "mailto:takamrushclin@gmail.com",
        icon: Icons.email,
  ...
  hackathons: [
    {
      ...
      location: "Dschang, Caméroun",
      description:
        "Nous avons proposé une solution dans le domaine agricole pour aider les agriculteurs à se regrouper autour d'une plateforme",
      image:
        "https://media.licdn.com/dms/image/v2/C4E0BAQH-nPjTTM_mYw/company-logo_200_200/company-logo_200_200/0/1646153645052?e=1741824000&v=beta&t=feHD_cpL1FIgKRt582PbTObcfssRIJeAyZOuzXMmKl8",
      mlh: "https://media.licdn.com/dms/image/v2/C4E0BAQH-nPjTTM_mYw/company-logo_200_200/company-logo_200_200/0/1646153645052?e=1741824000&v=beta&t=feHD_cpL1FIgKRt582PbTObcfssRIJeAyZOuzXMmKl8",
      links: [
        // {
        //   title: "Devpost",
